...
const endpointsSecret = process.env.STRIPE_SIGNING_SECRET
...
export default async (req, res) => {
    if (req.method === "POST") {
        ...
        //verify that the evnet posted came from stripe
        try {
            event = stripe.webhooks.constructEvent(payload, sig, endpointsSecret)
        } catch (err) {
